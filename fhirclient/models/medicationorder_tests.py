...
class MedicationOrderTests(unittest.TestCase):
    ...
    def implMedicationOrder1(self, inst):
        ...
        self.assertEqual(inst.reasonCode[0].coding[0].code, "13645005")
        self.assertEqual(inst.reasonCode[0].coding[0].display, "Chronic obstructive pulmonary disease")
    ...
    def implMedicationOrder2(self, inst):
        ...
        self.assertEqual(inst.reasonCode[0].coding[0].code, "28036006")
        self.assertEqual(inst.reasonCode[0].coding[0].display, "High density lipoprotein cholesterol level")
        self.assertEqual(inst.reasonCode[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.status, "active")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implMedicationOrder3(self, inst):
        ...
        self.assertEqual(inst.reasonCode[0].coding[0].code, "444780001")
        self.assertEqual(inst.reasonCode[0].coding[0].display, "High glucose level in blood")
        self.assertEqual(inst.reasonCode[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.status, "active")
        self.assertEqual(inst.text.status, "generated")
    ...
    def implMedicationOrder4(self, inst):
        ...
        self.assertEqual(inst.identifier[0].use, "official")
        self.assertEqual(inst.identifier[0].value, "order9845343")
        self.assertEqual(inst.reasonCode[0].coding[0].code, "38341003")
        self.assertEqual(inst.reasonCode[0].coding[0].display, "High blood pressure")
        self.assertEqual(inst.reasonCode[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.status, "active")
        self.assertEqual(inst.text.status, "generated")
