...
class ObservationTests(unittest.TestCase):
    ...
    def implObservation1(self, inst):
        ...
        self.assertEqual(inst.comment, "The EGFR p.L858R mutation has been associated with response to anti-EGFR therapy")
    ...
    def testObservation3(self):
        inst = self.instantiate_from("obs-genetics-example3-bcr1 and bcr2 sequencing with FamilyHistory -1.json")
        self.assertIsNotNone(inst, "Must have instantiated a Observation instance")
    ...
    def implObservation3(self, inst):
        self.assertEqual(inst.code.coding[0].code, "21636-6")
        self.assertEqual(inst.code.coding[0].display, "BRCA1 gene mutations found [Identifier] in Blood or Tissue by Molecular genetics method Nominal")
        self.assertEqual(inst.code.coding[0].system, "http://loinc.org")
        ...
        self.assertEqual(inst.id, "ob-genetics-3-1")
        self.assertEqual(inst.method.coding[0].code, "GTR000521311.1")
        self.assertEqual(inst.method.coding[0].display, "BRACAnalysis CDx Offered by Myriad Genetic Laboratories, Inc")
        self.assertEqual(inst.method.coding[0].system, "http://www.ncbi.nlm.nih.gov/gtr/")
        self.assertEqual(inst.status, "final")
        self.assertEqual(inst.text.status, "generated")
    ...
    def testObservation4(self):
        inst = self.instantiate_from("obs-genetics-example3-bcr1 and bcr2 sequencing with FamilyHistory -2.json")
        self.assertIsNotNone(inst, "Must have instantiated a Observation instance")
    ...
    def implObservation4(self, inst):
        self.assertEqual(inst.code.coding[0].code, "38530-2")
        self.assertEqual(inst.code.coding[0].display, "BRCA2 gene mutation analysis")
        self.assertEqual(inst.code.coding[0].system, "http://loinc.org")
        ...
        self.assertEqual(inst.component[0].valueCodeableConcept.coding[0].code, "LA6668-3")
        self.assertEqual(inst.component[0].valueCodeableConcept.coding[0].display, "Pathogenic")
        self.assertEqual(inst.effectiveDateTime.date, FHIRDate("2015-05-26T15:30:10+01:00").date)
        self.assertEqual(inst.effectiveDateTime.as_json(), "2015-05-26T15:30:10+01:00")
        self.assertEqual(inst.extension[0].url, "http://hl7.org/fhir/StructureDefinition/observation-geneticsSequence")
        self.assertEqual(inst.extension[1].extension[0].url, "genomeBuild")
        self.assertEqual(inst.extension[1].extension[0].valueCodeableConcept.text, "GRCh 38")
        self.assertEqual(inst.extension[1].extension[1].url, "name")
        self.assertEqual(inst.extension[1].extension[1].valueCodeableConcept.text, "185delAG")
        self.assertEqual(inst.extension[1].url, "http://hl7.org/fhir/StructureDefinition/observation-geneticsVariationHGVS")
        self.assertEqual(inst.id, "ob-genetics-3-2")
        self.assertEqual(inst.method.coding[0].code, "GTR000521311.1")
        self.assertEqual(inst.method.coding[0].display, "BRACAnalysis CDx Offered by Myriad Genetic Laboratories, Inc")
        self.assertEqual(inst.method.coding[0].system, "http://www.ncbi.nlm.nih.gov/gtr/")
        self.assertEqual(inst.status, "final")
    ...
    def testObservation10(self):
        inst = self.instantiate_from("observation-consensus-sequence-block-example-1.json")
        self.assertIsNotNone(inst, "Must have instantiated a Observation instance")
    ...
    def implObservation10(self, inst):
        self.assertEqual(inst.code.coding[0].code, "13298-5")
        self.assertEqual(inst.code.coding[0].system, "http://loinc.org")
        self.assertEqual(inst.contained[0].id, "variant-1")
        self.assertEqual(inst.contained[1].id, "variant-2")
        self.assertEqual(inst.extension[0].url, "http://hl7.org/fhir/StructureDefinition/observation-consensus-sequence-blockReferenceSeq")
        self.assertEqual(inst.extension[0].valueCodeableConcept.coding[0].code, "ref1")
        self.assertEqual(inst.extension[0].valueCodeableConcept.coding[0].system, "http://www.ncbi.nlm.nih.gov/projects/genome/assembly/grc/human/")
        self.assertEqual(inst.extension[1].url, "http://hl7.org/fhir/StructureDefinition/observation-consensus-sequence-blockStart")
        self.assertEqual(inst.extension[1].valueInteger, 29942412)
        self.assertEqual(inst.extension[2].url, "http://hl7.org/fhir/StructureDefinition/observation-consensus-sequence-blockEnd")
        self.assertEqual(inst.extension[2].valueInteger, 29942852)
        self.assertEqual(inst.extension[3].url, "http://hl7.org/fhir/StructureDefinition/observation-consensus-sequence-blockPhaseSet")
        self.assertEqual(inst.extension[3].valueInteger, 1)
        self.assertEqual(inst.extension[4].url, "http://hl7.org/fhir/StructureDefinition/observation-consensus-sequence-blockExpectedCopyNumber")
        self.assertEqual(inst.extension[4].valueInteger, 1)
        self.assertEqual(inst.extension[5].url, "http://hl7.org/fhir/StructureDefinition/observation-consensus-sequence-blockContinuity")
        self.assertTrue(inst.extension[5].valueBoolean)
        self.assertEqual(inst.extension[6].url, "http://hl7.org/fhir/StructureDefinition/observation-consensus-sequence-blockVariant")
        self.assertEqual(inst.extension[7].url, "http://hl7.org/fhir/StructureDefinition/observation-consensus-sequence-blockVariant")
        self.assertEqual(inst.id, "consensus-sequence-block-example-1")
        self.assertEqual(inst.status, "final")
        self.assertEqual(inst.text.status, "generated")
