...
class AllergyIntoleranceTests(unittest.TestCase):
    def instantiate_from(self, filename):
        ...
        with io.open(os.path.join(datadir, filename), 'r', encoding='utf-8') as handle:
            js = json.load(handle)
        instance = allergyintolerance.AllergyIntolerance(js)
        self.assertIsNotNone(instance, "Must have instantiated a test instance")
        return instance
    
    def testAllergyIntolerance1(self):
        inst = self.instantiate_from("allergyintolerance-example.json")
        self.assertIsNotNone(inst, "Must have instantiated a <fhirclass.FHIRClass object at 0x10e219e10> instance")
        ...
        self.assertEqual(inst.event[0].onset.isostring, "2012-06-12")
        ...
        self.assertEqual(inst.event[1].onset.isostring, "2004")
        ...
        self.assertEqual(inst.lastOccurence.isostring, "2012-06")
        self.assertEqual(inst.recordedDate.date, FHIRDate("2014-10-09T14:58:00+11:00").date)
        self.assertEqual(inst.recordedDate.isostring, "2014-10-09T14:58:00+11:00")
