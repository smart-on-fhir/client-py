...
class ConceptMapTests(unittest.TestCase):
    ...
    def implConceptMap1(self, inst):
        ...
        self.assertEqual(inst.element[0].system, "http://hl7.org/fhir/v2/0487")
        self.assertEqual(inst.element[0].target[0].code, "309068002")
        self.assertEqual(inst.element[0].target[0].equivalence, "equivalent")
        self.assertEqual(inst.element[0].target[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[1].code, "ACNFLD")
        self.assertEqual(inst.element[1].system, "http://hl7.org/fhir/v2/0487")
        ...
        self.assertEqual(inst.element[1].target[0].product[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[1].target[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[2].code, "AIRS")
        self.assertEqual(inst.element[2].system, "http://hl7.org/fhir/v2/0487")
        self.assertEqual(inst.element[2].target[0].code, "446302006")
        self.assertEqual(inst.element[2].target[0].equivalence, "equivalent")
        self.assertEqual(inst.element[2].target[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[3].code, "ALL")
        self.assertEqual(inst.element[3].system, "http://hl7.org/fhir/v2/0487")
        ...
        self.assertEqual(inst.element[3].target[0].product[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[3].target[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[4].code, "AMP")
        self.assertEqual(inst.element[4].system, "http://hl7.org/fhir/v2/0487")
        ...
        self.assertEqual(inst.element[4].target[0].product[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[4].target[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[5].code, "ANGI")
        self.assertEqual(inst.element[5].system, "http://hl7.org/fhir/v2/0487")
        ...
        self.assertEqual(inst.element[5].target[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[6].code, "ARTC")
        self.assertEqual(inst.element[6].system, "http://hl7.org/fhir/v2/0487")
        ...
        self.assertEqual(inst.element[6].target[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[7].code, "ASERU")
        self.assertEqual(inst.element[7].system, "http://hl7.org/fhir/v2/0487")
        self.assertEqual(inst.element[7].target[0].comments, "pending")
        self.assertEqual(inst.element[7].target[0].equivalence, "unmatched")
        self.assertEqual(inst.element[7].target[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[8].code, "ASP")
        self.assertEqual(inst.element[8].system, "http://hl7.org/fhir/v2/0487")
        ...
        self.assertEqual(inst.element[8].target[0].product[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[8].target[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.element[9].code, "ATTE")
        self.assertEqual(inst.element[9].system, "http://hl7.org/fhir/v2/0487")
        self.assertEqual(inst.element[9].target[0].comments, "TBD")
        self.assertEqual(inst.element[9].target[0].equivalence, "unmatched")
        self.assertEqual(inst.element[9].target[0].system, "http://snomed.info/sct")
    ...
    def implConceptMap2(self, inst):
        ...
        self.assertEqual(inst.element[0].system, "http://hl7.org/fhir/address-use")
        self.assertEqual(inst.element[0].target[0].code, "H")
        self.assertEqual(inst.element[0].target[0].equivalence, "equivalent")
        self.assertEqual(inst.element[0].target[0].system, "http://hl7.org/fhir/v3/AddressUse")
        self.assertEqual(inst.element[1].code, "home")
        self.assertEqual(inst.element[1].system, "http://hl7.org/fhir/address-use")
        self.assertEqual(inst.element[1].target[0].code, "H")
        self.assertEqual(inst.element[1].target[0].equivalence, "equivalent")
        self.assertEqual(inst.element[1].target[0].system, "http://hl7.org/fhir/v3/AddressUse")
        self.assertEqual(inst.element[2].code, "work")
        self.assertEqual(inst.element[2].system, "http://hl7.org/fhir/address-use")
        self.assertEqual(inst.element[2].target[0].code, "WP")
        self.assertEqual(inst.element[2].target[0].equivalence, "equivalent")
        self.assertEqual(inst.element[2].target[0].system, "http://hl7.org/fhir/v3/AddressUse")
        self.assertEqual(inst.element[3].code, "temp")
        self.assertEqual(inst.element[3].system, "http://hl7.org/fhir/address-use")
        self.assertEqual(inst.element[3].target[0].code, "TMP")
        self.assertEqual(inst.element[3].target[0].equivalence, "equivalent")
        self.assertEqual(inst.element[3].target[0].system, "http://hl7.org/fhir/v3/AddressUse")
        self.assertEqual(inst.element[4].code, "old")
        self.assertEqual(inst.element[4].system, "http://hl7.org/fhir/address-use")
        ...
        self.assertEqual(inst.element[4].target[0].system, "http://hl7.org/fhir/v3/AddressUse")
