...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim1(self, inst):
        ...
        self.assertEqual(inst.accident.type.coding[0].system, "http://hl7.org/fhir/ValueSet/v3-ActIncidentCode")
        ...
        self.assertEqual(inst.careTeam[0].qualification.coding[0].system, "http://hl7.org/fhir/ValueSet/provider-qualification")
        self.assertTrue(inst.careTeam[0].responsible)
        self.assertEqual(inst.careTeam[0].role.coding[0].code, "primary")
        self.assertEqual(inst.careTeam[0].role.coding[0].system, "http://hl7.org/fhir/ValueSet/claim-careteamrole")
        ...
        self.assertEqual(inst.diagnosis[0].packageCode.coding[0].system, "http://hl7.org/fhir/ValueSet/ex-diagnosisrelatedgroup")
        self.assertEqual(inst.diagnosis[0].sequence, 1)
        self.assertEqual(inst.diagnosis[0].type[0].coding[0].code, "admitting")
        self.assertEqual(inst.diagnosis[0].type[0].coding[0].system, "http://hl7.org/fhir/ValueSet/ex-diagnosistype")
