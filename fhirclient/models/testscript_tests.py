...
class TestScriptTests(unittest.TestCase):
    ...
    def implTestScript1(self, inst):
        ...
        self.assertEqual(inst.setup.metadata.capability[0].destination, 1)
        self.assertEqual(inst.setup.metadata.capability[0].link[0], "http://hl7.org/implement/standards/FHIR-Develop/http.html#create")
        self.assertEqual(inst.setup.metadata.capability[0].origin[0], 1)
        self.assertTrue(inst.setup.metadata.capability[0].required)
        self.assertTrue(inst.setup.metadata.capability[0].validated)
        ...
        self.assertEqual(inst.test[0].metadata.capability[0].destination, 1)
        self.assertEqual(inst.test[0].metadata.capability[0].link[0], "http://hl7.org/implement/standards/FHIR-Develop/http.html#read")
        self.assertEqual(inst.test[0].metadata.capability[0].origin[0], 1)
        self.assertTrue(inst.test[0].metadata.capability[0].required)
