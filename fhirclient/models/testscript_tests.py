...
class TestScriptTests(unittest.TestCase):
    ...
    def implTestScript1(self, inst):
        ...
        self.assertEqual(inst.metadata.capability[0].description, "Patient Create Operation")
        ...
        self.assertTrue(inst.metadata.capability[0].validated)
        self.assertEqual(inst.metadata.capability[1].description, "Patient Read Operation")
        self.assertEqual(inst.metadata.capability[1].link[0], "http://hl7.org/implement/standards/FHIR-Develop/http.html#read")
        self.assertTrue(inst.metadata.capability[1].validated)
        self.assertEqual(inst.metadata.capability[2].description, "Patient Update Operation")
        self.assertEqual(inst.metadata.capability[2].link[0], "http://hl7.org/implement/standards/FHIR-Develop/http.html#update")
        self.assertTrue(inst.metadata.capability[2].validated)
        ...
        self.assertEqual(inst.setup.action[0].operation.origin, 0)
    ...
    def implTestScript2(self, inst):
        ...
        self.assertEqual(inst.fixture[0].id, "F1")
        self.assertEqual(inst.id, "example-rule")
        ...
        self.assertEqual(inst.rule[0].id, "ruleResponseOkay")
        ...
        self.assertEqual(inst.test[0].action[7].assert_fhir.sourceId, "F1")
        self.assertEqual(inst.test[0].action[7].assert_fhir.value, "Chalmers")
        ...
        self.assertEqual(inst.test[0].action[9].assert_fhir.compareToSourceId, "F1-read")
        self.assertEqual(inst.test[0].action[9].assert_fhir.compareToSourcePath, "fhir:Patient/fhir:name/fhir:family/@value")
        self.assertEqual(inst.test[0].action[9].assert_fhir.path, "fhir:Patient/fhir:name/fhir:family/@value")
        self.assertEqual(inst.test[0].action[9].assert_fhir.sourceId, "F1")
        self.assertEqual(inst.test[0].description, "Read a patient and validate response.")
        self.assertEqual(inst.test[0].id, "READ01")
        self.assertEqual(inst.test[0].name, "Read Patient")
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(inst.url, "http://hl7.org/fhir/TestScript/example-rule")
