...
class ProcedureRequestTests(unittest.TestCase):
    def instantiate_from(self, filename):
        ...
        with io.open(os.path.join(datadir, filename), 'r', encoding='utf-8') as handle:
            js = json.load(handle)
        instance = procedurerequest.ProcedureRequest(js)
        self.assertIsNotNone(instance, "Must have instantiated a test instance")
        return instance
    
    def testProcedureRequest1(self):
        inst = self.instantiate_from("procedurerequest-example.json")
        self.assertIsNotNone(inst, "Must have instantiated a <fhirclass.FHIRClass object at 0x10e378190> instance")
    ...
    def testProcedureRequest2(self):
        ...
        self.assertEqual(inst.orderedOn.isostring, "2013-04-04")
        ...
        self.assertEqual(inst.timingDateTime.isostring, "2013-04-05")
