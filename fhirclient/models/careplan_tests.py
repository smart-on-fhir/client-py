...
class CarePlanTests(unittest.TestCase):
    def instantiate_from(self, filename):
        ...
        with io.open(os.path.join(datadir, filename), 'r', encoding='utf-8') as handle:
            js = json.load(handle)
        instance = careplan.CarePlan(js)
        self.assertIsNotNone(instance, "Must have instantiated a test instance")
        return instance
    
    def testCarePlan1(self):
        inst = self.instantiate_from("careplan-example-f001-heart.json")
        self.assertIsNotNone(inst, "Must have instantiated a <fhirclass.FHIRClass object at 0x10e2672d0> instance")
    ...
    def testCarePlan7(self):
        ...
        self.assertEqual(inst.activity[0].detail.scheduledPeriod.end.isostring, "2013-01-01T10:50:00+00:00")
        self.assertEqual(inst.activity[0].detail.scheduledPeriod.start.date, FHIRDate("2013-01-01T10:38:00+00:00").date)
        self.assertEqual(inst.activity[0].detail.scheduledPeriod.start.isostring, "2013-01-01T10:38:00+00:00")
        self.assertEqual(inst.activity[0].detail.status, "completed")
    ...
    def testCarePlan8(self):
        ...
        self.assertEqual(inst.activity[0].detail.extension[0].valueDate.isostring, "2012-09-10")
        ...
        self.assertEqual(inst.activity[0].detail.scheduledPeriod.start.isostring, "2012-09-10")
        self.assertEqual(inst.activity[0].detail.status, "not-started")
        ...
        self.assertEqual(inst.activity[1].detail.extension[0].valueDate.isostring, "2012-09-10")
        ...
        self.assertEqual(inst.activity[1].detail.scheduledPeriod.start.isostring, "2012-09-10")
        ...
        self.assertEqual(inst.activity[2].detail.extension[0].valueDate.isostring, "2012-09-10")
        ...
        self.assertEqual(inst.activity[2].detail.scheduledPeriod.start.isostring, "2012-09-10")
        ...
        self.assertEqual(inst.activity[3].detail.extension[0].valueDate.isostring, "2012-09-10")
        ...
        self.assertEqual(inst.activity[3].detail.scheduledPeriod.start.isostring, "2012-08-27")
        ...
        self.assertEqual(inst.activity[4].detail.extension[0].valueDate.isostring, "2012-09-10")
        ...
        self.assertEqual(inst.activity[4].detail.scheduledPeriod.start.isostring, "2012-07-23")
        ...
        self.assertEqual(inst.activity[5].detail.extension[0].valueDate.isostring, "2012-08-13")
        ...
        self.assertEqual(inst.activity[5].detail.scheduledPeriod.start.isostring, "2012-07-23")
        ...
        self.assertEqual(inst.activity[6].detail.extension[0].valueDate.isostring, "2012-08-27")
        ...
        self.assertEqual(inst.activity[6].detail.scheduledPeriod.start.isostring, "2012-07-23")
        ...
        self.assertEqual(inst.activity[7].detail.extension[0].valueDate.isostring, "2012-09-10")
        ...
        self.assertEqual(inst.activity[7].detail.scheduledPeriod.start.isostring, "2012-07-10")
        ...
        self.assertEqual(inst.activity[8].detail.extension[0].valueDate.isostring, "2012-08-23")
        ...
        self.assertEqual(inst.activity[8].detail.scheduledPeriod.start.isostring, "2012-07-23")
        ...
        self.assertEqual(inst.activity[9].detail.extension[0].valueDate.isostring, "2012-07-23")
        ...
        self.assertEqual(inst.activity[9].detail.scheduledPeriod.start.isostring, "2012-07-10")
    ...
    def testCarePlan9(self):
        ...
        self.assertEqual(inst.activity[0].detail.scheduledTiming.repeat.bounds.end.isostring, "2013-02-28")
        self.assertEqual(inst.activity[0].detail.scheduledTiming.repeat.bounds.start.date, FHIRDate("2013-02-14").date)
        self.assertEqual(inst.activity[0].detail.scheduledTiming.repeat.bounds.start.isostring, "2013-02-14")
        ...
        self.assertEqual(inst.activity[1].detail.scheduledTiming.repeat.bounds.end.isostring, "2013-03-14")
        self.assertEqual(inst.activity[1].detail.scheduledTiming.repeat.bounds.start.date, FHIRDate("2013-03-01").date)
        self.assertEqual(inst.activity[1].detail.scheduledTiming.repeat.bounds.start.isostring, "2013-03-01")
        self.assertEqual(inst.activity[1].detail.status, "not-started")
        ...
        self.assertEqual(inst.activity[2].detail.scheduledTiming.repeat.bounds.end.isostring, "2013-09-14")
        self.assertEqual(inst.activity[2].detail.scheduledTiming.repeat.bounds.start.date, FHIRDate("2013-09-01").date)
        self.assertEqual(inst.activity[2].detail.scheduledTiming.repeat.bounds.start.isostring, "2013-09-01")
        ...
        self.assertEqual(inst.extension[0].valueDateTime.isostring, "2013-01-01")
    ...
    def testCarePlan10(self):
        ...
        self.assertEqual(inst.period.end.isostring, "2013-01-01")
        self.assertEqual(inst.status, "active")
        self.assertEqual(inst.text.status, "additional")
