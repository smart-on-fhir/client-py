...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 0.4.0.3933 (enrollmentresponse.profile.json) on 2015-01-10.
...
class EnrollmentResponse(fhirresource.FHIRResource):
    ...
    def update_with_json(self, jsondict):
        super(EnrollmentResponse, self).update_with_json(jsondict)
