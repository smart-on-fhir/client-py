...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.4.0.8595 (http://hl7.org/fhir/StructureDefinition/Specimen) on 2016-06-26.
...
class Specimen(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        List of `FHIRReference` items referencing `DiagnosticOrder, ProcedureRequest` (represented as `dict` in JSON). """
