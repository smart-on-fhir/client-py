...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 0.4.0.3933 (statusrequest.profile.json) on 2015-01-10.
...
class StatusRequest(fhirresource.FHIRResource):
    """ StatusRequest request.
    
    This resource provides the request and response details for the resource
    for which the processing status is to be checked.
    """
    ...
    def __init__(self, jsondict=None):
        ...
        super(StatusRequest, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(StatusRequest, self).update_with_json(jsondict)
