...
class PractitionerTests(unittest.TestCase):
    ...
    def implPractitioner1(self, inst):
        ...
        self.assertEqual(inst.role[0].code.coding[0].code, "01.000")
        self.assertEqual(inst.role[0].code.coding[0].display, "Arts")
        self.assertEqual(inst.role[0].code.coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.111")
        self.assertEqual(inst.role[0].code.text, "Care role")
        self.assertEqual(inst.role[0].specialty[0].coding[0].code, "01.018")
        self.assertEqual(inst.role[0].specialty[0].coding[0].display, "Ear-, Nose and Throat")
        self.assertEqual(inst.role[0].specialty[0].coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.111")
        self.assertEqual(inst.role[0].specialty[0].text, "specialization")
    ...
    def implPractitioner2(self, inst):
        ...
        self.assertEqual(inst.role[0].code.coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.111")
        self.assertEqual(inst.role[0].code.text, "Care role")
        self.assertEqual(inst.role[0].specialty[0].coding[0].code, "01.011")
        self.assertEqual(inst.role[0].specialty[0].coding[0].display, "Cardiothoracal surgery")
        self.assertEqual(inst.role[0].specialty[0].coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.111")
        self.assertEqual(inst.role[0].specialty[0].text, "specialization")
        self.assertEqual(inst.telecom[0].system, "phone")
        self.assertEqual(inst.telecom[0].use, "work")
    ...
    def implPractitioner5(self, inst):
        ...
        self.assertEqual(inst.role[0].code.text, "Care role")
        self.assertEqual(inst.role[0].specialty[0].coding[0].code, "01.018")
        self.assertEqual(inst.role[0].specialty[0].coding[0].display, "Keel- neus- en oorarts")
        self.assertEqual(inst.role[0].specialty[0].coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.111")
        self.assertEqual(inst.role[0].specialty[0].text, "specialization")
        self.assertEqual(inst.telecom[0].system, "phone")
        self.assertEqual(inst.telecom[0].use, "work")
    ...
    def implPractitioner6(self, inst):
        ...
        self.assertEqual(inst.role[0].code.coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.111")
        self.assertEqual(inst.role[0].code.text, "Care role")
        self.assertEqual(inst.role[0].specialty[0].coding[0].code, "17.000")
        self.assertEqual(inst.role[0].specialty[0].coding[0].display, "Pharmacist")
        self.assertEqual(inst.role[0].specialty[0].coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.111")
        self.assertEqual(inst.role[0].specialty[0].text, "specialization")
        self.assertEqual(inst.telecom[0].system, "phone")
        self.assertEqual(inst.telecom[0].use, "work")
    ...
    def implPractitioner7(self, inst):
        ...
        self.assertEqual(inst.role[0].code.coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.111")
        self.assertEqual(inst.role[0].code.text, "Care role")
        self.assertEqual(inst.role[0].specialty[0].coding[0].code, "01.015")
        self.assertEqual(inst.role[0].specialty[0].coding[0].display, "Physician")
        self.assertEqual(inst.role[0].specialty[0].coding[0].system, "urn:oid:2.16.840.1.113883.2.4.15.111")
        self.assertEqual(inst.role[0].specialty[0].text, "specialization")
        self.assertEqual(inst.telecom[0].system, "phone")
        self.assertEqual(inst.telecom[0].use, "work")
    ...
    def implPractitioner8(self, inst):
        ...
        self.assertEqual(inst.role[0].code.coding[0].code, "225304007")
        self.assertEqual(inst.role[0].code.coding[0].display, "Implementation of planned interventions")
        self.assertEqual(inst.role[0].code.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.role[0].specialty[0].coding[0].code, "310512001")
        self.assertEqual(inst.role[0].specialty[0].coding[0].display, "Medical oncologist")
        self.assertEqual(inst.role[0].specialty[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.telecom[0].system, "phone")
        self.assertEqual(inst.telecom[0].use, "work")
    ...
    def implPractitioner9(self, inst):
        ...
        self.assertEqual(inst.name[0].use, "official")
        self.assertEqual(inst.role[0].code.coding[0].code, "33526004")
        self.assertEqual(inst.role[0].code.coding[0].display, "Electronic laboratory reporting")
        self.assertEqual(inst.role[0].code.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.role[0].specialty[0].coding[0].code, "159285000")
        self.assertEqual(inst.role[0].specialty[0].coding[0].display, "Medical laboratory technician")
        self.assertEqual(inst.role[0].specialty[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.telecom[0].system, "phone")
        self.assertEqual(inst.telecom[0].use, "work")
        self.assertEqual(inst.telecom[0].value, "+31715269111")
    ...
    def implPractitioner10(self, inst):
        ...
        self.assertEqual(inst.name[0].use, "official")
        self.assertEqual(inst.role[0].code.coding[0].code, "36682004")
        self.assertEqual(inst.role[0].code.coding[0].display, "Physical therapist")
        self.assertEqual(inst.role[0].code.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.role[0].specialty[0].coding[0].code, "410158009")
        self.assertEqual(inst.role[0].specialty[0].coding[0].display, "Assess physical therapist service")
        self.assertEqual(inst.role[0].specialty[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.telecom[0].system, "phone")
        self.assertEqual(inst.telecom[0].use, "work")
        self.assertEqual(inst.telecom[0].value, "+31715269111")
