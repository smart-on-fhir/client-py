...
class ProcedureTests(unittest.TestCase):
    ...
    def implProcedure9(self, inst):
        ...
        self.assertEqual(inst.extension[1].valueDateTime.as_json(), "2013-04-05T09:30:00-04:00")
        ...
        self.assertEqual(inst.performedPeriod.end.as_json(), "2013-04-05T10:30:00-04:00")
        self.assertEqual(inst.performedPeriod.start.date, FHIRDate("2013-04-05T09:20:00-04:00").date)
        self.assertEqual(inst.performedPeriod.start.as_json(), "2013-04-05T09:20:00-04:00")
        self.assertEqual(inst.status, "completed")
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(inst.type.coding[0].code, "80146002")
        self.assertEqual(inst.type.coding[0].display, "Appendectomy (Procedure)")
