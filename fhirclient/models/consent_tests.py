...
class ConsentTests(unittest.TestCase):
    ...
    def implConsent4(self, inst):
        ...
        self.assertEqual(inst.except_fhir[0].action[0].coding[0].code, "read")
        self.assertEqual(inst.except_fhir[0].action[0].coding[0].system, "http://hl7.org/fhir/consentaction")
        self.assertEqual(inst.except_fhir[0].action[1].coding[0].code, "write")
    ...
    def implConsent9(self, inst):
        ...
        self.assertEqual(inst.except_fhir[0].type, "permit")
        self.assertEqual(inst.except_fhir[1].action[0].coding[0].code, "read")
        ...
        self.assertEqual(inst.except_fhir[2].action[0].coding[0].code, "read")
        ...
        self.assertEqual(inst.except_fhir[3].action[0].coding[0].code, "read")
        ...
        self.assertEqual(inst.except_fhir[4].action[0].coding[0].code, "read")
        ...
        self.assertEqual(inst.except_fhir[5].action[0].coding[0].code, "read")
        ...
        self.assertEqual(inst.except_fhir[6].action[0].coding[0].code, "read")
        ...
        self.assertEqual(inst.except_fhir[7].action[0].coding[0].code, "read")
        ...
        self.assertEqual(inst.except_fhir[8].action[0].coding[0].code, "read")
        ...
        self.assertEqual(inst.except_fhir[9].action[0].coding[0].code, "read")
