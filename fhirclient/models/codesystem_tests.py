...
class CodeSystemTests(unittest.TestCase):
    ...
    def implCodeSystem2(self, inst):
        ...
        self.assertEqual(inst.meta.lastUpdated.date, FHIRDate("2016-03-16T13:04:25.079+00:00").date)
        self.assertEqual(inst.meta.lastUpdated.as_json(), "2016-03-16T13:04:25.079+00:00")
