...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 0.4.0.3933 (visionclaim.profile.json) on 2015-01-10.
...
class VisionClaim(fhirresource.FHIRResource):
    """ Claim, Pre-determination or Preauthorization.
    ...
    def __init__(self, jsondict=None):
        ...
        List of `VisionClaimCoverage` items (represented as `dict` in JSON). """
        ...
        self.diagnosis = None
        """ Diagnosis.
        List of `VisionClaimDiagnosis` items (represented as `dict` in JSON). """
        ...
        self.item = None
        """ Goods and Services.
        List of `VisionClaimItem` items (represented as `dict` in JSON). """
        ...
        self.payee = None
        """ Payee.
        Type `VisionClaimPayee` (represented as `dict` in JSON). """
        
        self.prescription = None
        """ Prescription.
        Type `FHIRReference` referencing `VisionPrescription` (represented as `dict` in JSON). """
        ...
        super(VisionClaim, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(VisionClaim, self).update_with_json(jsondict)
        ...
        if 'coverage' in jsondict:
            self.coverage = VisionClaimCoverage.with_json_and_owner(jsondict['coverage'], self)
        if 'created' in jsondict:
            self.created = fhirdate.FHIRDate.with_json_and_owner(jsondict['created'], self)
        if 'diagnosis' in jsondict:
            self.diagnosis = VisionClaimDiagnosis.with_json_and_owner(jsondict['diagnosis'], self)
        ...
        if 'item' in jsondict:
            self.item = VisionClaimItem.with_json_and_owner(jsondict['item'], self)
        ...
        if 'payee' in jsondict:
            self.payee = VisionClaimPayee.with_json_and_owner(jsondict['payee'], self)
...
class VisionClaimCoverage(fhirelement.FHIRElement):
    """ Insurance or medical plan.
    
    Financial instrument by which payment information for health care.
    """
    
    resource_name = "VisionClaimCoverage"
    ...
    def __init__(self, jsondict=None):
        ...
        super(VisionClaimCoverage, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(VisionClaimCoverage, self).update_with_json(jsondict)
...
class VisionClaimDiagnosis(fhirelement.FHIRElement):
    """ Diagnosis.
    
    Ordered list of patient diagnosis for which care is sought.
    """
    
    resource_name = "VisionClaimDiagnosis"
    ...
    def __init__(self, jsondict=None):
        ...
        super(VisionClaimDiagnosis, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(VisionClaimDiagnosis, self).update_with_json(jsondict)
        if 'diagnosis' in jsondict:
...
class VisionClaimItem(fhirelement.FHIRElement):
    """ Goods and Services.
    
    First tier of goods and services.
    """
    
    resource_name = "VisionClaimItem"
    ...
    def __init__(self, jsondict=None):
        ...
        self.detail = None
        """ Additional items.
        List of `VisionClaimItemDetail` items (represented as `dict` in JSON). """
        ...
        super(VisionClaimItem, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(VisionClaimItem, self).update_with_json(jsondict)
        if 'bodySite' in jsondict:
            self.bodySite = coding.Coding.with_json_and_owner(jsondict['bodySite'], self)
        if 'detail' in jsondict:
            self.detail = VisionClaimItemDetail.with_json_and_owner(jsondict['detail'], self)
...
class VisionClaimItemDetail(fhirelement.FHIRElement):
    """ Additional items.
    
    Second tier of goods and services.
    """
    
    resource_name = "VisionClaimItemDetail"
    ...
    def __init__(self, jsondict=None):
        ...
        self.subDetail = None
        """ Additional items.
        List of `VisionClaimItemDetailSubDetail` items (represented as `dict` in JSON). """
        ...
        super(VisionClaimItemDetail, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(VisionClaimItemDetail, self).update_with_json(jsondict)
        if 'factor' in jsondict:
            self.factor = jsondict['factor']
        if 'net' in jsondict:
            self.net = money.Money.with_json_and_owner(jsondict['net'], self)
        ...
        if 'subDetail' in jsondict:
            self.subDetail = VisionClaimItemDetailSubDetail.with_json_and_owner(jsondict['subDetail'], self)
        if 'type' in jsondict:
            self.type = coding.Coding.with_json_and_owner(jsondict['type'], self)
        if 'udi' in jsondict:
            self.udi = coding.Coding.with_json_and_owner(jsondict['udi'], self)
...
class VisionClaimItemDetailSubDetail(fhirelement.FHIRElement):
    """ Additional items.
    
    Third tier of goods and services.
    """
    
    resource_name = "VisionClaimItemDetailSubDetail"
    ...
    def __init__(self, jsondict=None):
        ...
        super(VisionClaimItemDetailSubDetail, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(VisionClaimItemDetailSubDetail, self).update_with_json(jsondict)
        if 'factor' in jsondict:
            self.factor = jsondict['factor']
        if 'net' in jsondict:
            self.net = money.Money.with_json_and_owner(jsondict['net'], self)
...
class VisionClaimPayee(fhirelement.FHIRElement):
    """ Payee.
    
    The party to be reimbursed for the services.
    """
    
    resource_name = "VisionClaimPayee"
    ...
    def __init__(self, jsondict=None):
        ...
        super(VisionClaimPayee, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(VisionClaimPayee, self).update_with_json(jsondict)
        if 'organization' in jsondict:
            self.organization = fhirreference.FHIRReference.with_json_and_owner(jsondict['organization'], self)
