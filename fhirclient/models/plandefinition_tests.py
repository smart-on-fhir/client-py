...
class PlanDefinitionTests(unittest.TestCase):
    ...
    def implPlanDefinition1(self, inst):
        ...
        self.assertEqual(inst.coverage[0].clinicalFocus[0].coding[0].code, "87512008")
        self.assertEqual(inst.coverage[0].clinicalFocus[0].coding[0].display, "Mild major depression")
        self.assertEqual(inst.coverage[0].clinicalFocus[1].coding[0].code, "40379007")
        self.assertEqual(inst.coverage[0].clinicalFocus[1].coding[0].display, "Major depression, recurrent, mild")
        self.assertEqual(inst.coverage[0].clinicalFocus[2].coding[0].code, "394687007")
        self.assertEqual(inst.coverage[0].clinicalFocus[2].coding[0].display, "Low suicide risk")
        self.assertEqual(inst.coverage[0].clinicalFocus[3].coding[0].code, "225337009")
        self.assertEqual(inst.coverage[0].clinicalFocus[3].coding[0].display, "Suicide risk assessment")
        self.assertEqual(inst.coverage[0].clinicalVenue[0].coding[0].code, "440655000")
        self.assertEqual(inst.coverage[0].clinicalVenue[0].coding[0].display, "Outpatient environment")
        self.assertEqual(inst.coverage[0].patientAgeGroup[0].coding[0].code, "133936004")
        self.assertEqual(inst.coverage[0].patientAgeGroup[0].coding[0].display, "Adult")
        self.assertEqual(inst.coverage[0].targetUser[0].coding[0].code, "309343006")
        self.assertEqual(inst.coverage[0].targetUser[0].coding[0].display, "Physician")
        self.assertEqual(inst.description, "...")
        self.assertEqual(inst.id, "example")
        self.assertEqual(inst.identifier[0].use, "official")
        self.assertEqual(inst.identifier[0].value, "mmi:low-suicide-risk-order-set")
        self.assertEqual(inst.publicationDate.date, FHIRDate("2015-08-15").date)
        self.assertEqual(inst.publicationDate.as_json(), "2015-08-15")
