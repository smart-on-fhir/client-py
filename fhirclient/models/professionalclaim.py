...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 0.4.0.3933 (professionalclaim.profile.json) on 2015-01-10.
...
class ProfessionalClaim(fhirresource.FHIRResource):
    ...
    resource_name = "ProfessionalClaim"
    ...
    def __init__(self, jsondict=None):
        ...
        List of `ProfessionalClaimCoverage` items (represented as `dict` in JSON). """
        ...
        self.diagnosis = None
        """ Diagnosis.
        List of `ProfessionalClaimDiagnosis` items (represented as `dict` in JSON). """
        ...
        self.item = None
        """ Goods and Services.
        List of `ProfessionalClaimItem` items (represented as `dict` in JSON). """
        ...
        self.payee = None
        """ Payee.
        Type `ProfessionalClaimPayee` (represented as `dict` in JSON). """
        ...
        super(ProfessionalClaim, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(ProfessionalClaim, self).update_with_json(jsondict)
        ...
        if 'coverage' in jsondict:
            self.coverage = ProfessionalClaimCoverage.with_json_and_owner(jsondict['coverage'], self)
        if 'created' in jsondict:
            self.created = fhirdate.FHIRDate.with_json_and_owner(jsondict['created'], self)
        if 'diagnosis' in jsondict:
            self.diagnosis = ProfessionalClaimDiagnosis.with_json_and_owner(jsondict['diagnosis'], self)
        ...
        if 'item' in jsondict:
            self.item = ProfessionalClaimItem.with_json_and_owner(jsondict['item'], self)
        ...
        if 'payee' in jsondict:
            self.payee = ProfessionalClaimPayee.with_json_and_owner(jsondict['payee'], self)
...
class ProfessionalClaimCoverage(fhirelement.FHIRElement):
    """ Insurance or medical plan.
    
    Financial instrument by which payment information for health care.
    """
    
    resource_name = "ProfessionalClaimCoverage"
    ...
    def __init__(self, jsondict=None):
        ...
        super(ProfessionalClaimCoverage, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(ProfessionalClaimCoverage, self).update_with_json(jsondict)
...
class ProfessionalClaimDiagnosis(fhirelement.FHIRElement):
    """ Diagnosis.
    
    Ordered list of patient diagnosis for which care is sought.
    """
    
    resource_name = "ProfessionalClaimDiagnosis"
    ...
    def __init__(self, jsondict=None):
        ...
        super(ProfessionalClaimDiagnosis, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(ProfessionalClaimDiagnosis, self).update_with_json(jsondict)
        if 'diagnosis' in jsondict:
...
class ProfessionalClaimItem(fhirelement.FHIRElement):
    """ Goods and Services.
    
    First tier of goods and services.
    """
    
    resource_name = "ProfessionalClaimItem"
    ...
    def __init__(self, jsondict=None):
        ...
        self.detail = None
        """ Additional items.
        List of `ProfessionalClaimItemDetail` items (represented as `dict` in JSON). """
        ...
        super(ProfessionalClaimItem, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(ProfessionalClaimItem, self).update_with_json(jsondict)
        if 'bodySite' in jsondict:
            self.bodySite = coding.Coding.with_json_and_owner(jsondict['bodySite'], self)
        if 'detail' in jsondict:
            self.detail = ProfessionalClaimItemDetail.with_json_and_owner(jsondict['detail'], self)
...
class ProfessionalClaimItemDetail(fhirelement.FHIRElement):
    """ Additional items.
    
    Second tier of goods and services.
    """
    
    resource_name = "ProfessionalClaimItemDetail"
    ...
    def __init__(self, jsondict=None):
        ...
        self.subDetail = None
        """ Additional items.
        List of `ProfessionalClaimItemDetailSubDetail` items (represented as `dict` in JSON). """
        ...
        super(ProfessionalClaimItemDetail, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(ProfessionalClaimItemDetail, self).update_with_json(jsondict)
        if 'factor' in jsondict:
            self.factor = jsondict['factor']
        if 'net' in jsondict:
            self.net = money.Money.with_json_and_owner(jsondict['net'], self)
        ...
        if 'subDetail' in jsondict:
            self.subDetail = ProfessionalClaimItemDetailSubDetail.with_json_and_owner(jsondict['subDetail'], self)
        if 'type' in jsondict:
            self.type = coding.Coding.with_json_and_owner(jsondict['type'], self)
        if 'udi' in jsondict:
            self.udi = coding.Coding.with_json_and_owner(jsondict['udi'], self)
...
class ProfessionalClaimItemDetailSubDetail(fhirelement.FHIRElement):
    """ Additional items.
    
    Third tier of goods and services.
    """
    
    resource_name = "ProfessionalClaimItemDetailSubDetail"
    ...
    def __init__(self, jsondict=None):
        ...
        super(ProfessionalClaimItemDetailSubDetail, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(ProfessionalClaimItemDetailSubDetail, self).update_with_json(jsondict)
        if 'factor' in jsondict:
            self.factor = jsondict['factor']
        if 'net' in jsondict:
            self.net = money.Money.with_json_and_owner(jsondict['net'], self)
...
class ProfessionalClaimPayee(fhirelement.FHIRElement):
    """ Payee.
    
    The party to be reimbursed for the services.
    """
    
    resource_name = "ProfessionalClaimPayee"
    ...
    def __init__(self, jsondict=None):
        ...
        super(ProfessionalClaimPayee, self).__init__(jsondict)
    
    def update_with_json(self, jsondict):
        super(ProfessionalClaimPayee, self).update_with_json(jsondict)
        if 'organization' in jsondict:
            self.organization = fhirreference.FHIRReference.with_json_and_owner(jsondict['organization'], self)
