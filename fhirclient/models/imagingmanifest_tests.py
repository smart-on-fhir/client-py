...
class ImagingManifestTests(unittest.TestCase):
    ...
    def implImagingManifest1(self, inst):
        ...
        self.assertEqual(inst.study[0].baseLocation[0].type.code, "WADO-RS")
        self.assertEqual(inst.study[0].baseLocation[0].url, "http://localhost/wado/SCP/2.16.124.113543.6003.189642796.63084.16749.2599092904")
        ...
        self.assertEqual(inst.text.div, "<div xmlns=\"http://www.w3.org/1999/xhtml\">A set of images accompanying to an exam document, including one SC image and two CT images, to publish the exam sharing</div>")
