...
class QuestionnaireTests(unittest.TestCase):
    ...
    def implQuestionnaire2(self, inst):
        self.assertEqual(inst.concept[0].code, "VL 1-1, 18-65_1.2.2")
        self.assertEqual(inst.concept[0].display, "Lifelines Questionnaire 1 part 1")
        self.assertEqual(inst.concept[0].system, "http://example.org/system/code/lifelines/nl")
    ...
    def implQuestionnaire3(self, inst):
        self.assertEqual(inst.concept[0].code, "9269-2")
        self.assertEqual(inst.concept[0].system, "http://loinc.org")
        ...
        self.assertEqual(inst.item[0].concept[0].code, "9270-0")
        self.assertEqual(inst.item[0].concept[0].system, "http://loinc.org")
        self.assertEqual(inst.item[0].linkId, "1.1")
        self.assertEqual(inst.item[0].type, "choice")
        self.assertEqual(inst.item[1].concept[0].code, "9268-4")
        self.assertEqual(inst.item[1].concept[0].system, "http://loinc.org")
        self.assertEqual(inst.item[1].linkId, "1.2")
        self.assertEqual(inst.item[1].type, "choice")
        self.assertEqual(inst.item[2].concept[0].code, "9267-6")
        self.assertEqual(inst.item[2].concept[0].system, "http://loinc.org")
    ...
    def implQuestionnaire4(self, inst):
        ...
        self.assertEqual(inst.item[0].concept[0].code, "COMORBIDITY")
        self.assertEqual(inst.item[0].concept[0].system, "http://example.org/system/code/sections")
        self.assertEqual(inst.item[0].item[0].concept[0].code, "COMORB")
        self.assertEqual(inst.item[0].item[0].concept[0].system, "http://example.org/system/code/questions")
        self.assertEqual(inst.item[0].item[0].item[0].concept[0].code, "CARDIAL")
        self.assertEqual(inst.item[0].item[0].item[0].concept[0].system, "http://example.org/system/code/sections")
        self.assertEqual(inst.item[0].item[0].item[0].item[0].concept[0].code, "COMORBCAR")
        self.assertEqual(inst.item[0].item[0].item[0].item[0].concept[0].system, "http://example.org/system/code/questions")
        ...
        self.assertEqual(inst.item[0].item[0].item[0].item[1].concept[0].code, "COMCAR00")
        self.assertEqual(inst.item[0].item[0].item[0].item[1].concept[0].display, "Angina Pectoris")
        self.assertEqual(inst.item[0].item[0].item[0].item[1].concept[0].system, "http://example.org/system/code/questions")
        self.assertEqual(inst.item[0].item[0].item[0].item[1].concept[1].code, "194828000")
        self.assertEqual(inst.item[0].item[0].item[0].item[1].concept[1].display, "Angina (disorder)")
        self.assertEqual(inst.item[0].item[0].item[0].item[1].concept[1].system, "http://snomed.info/sct")
        ...
        self.assertEqual(inst.item[0].item[0].item[0].item[2].concept[0].code, "22298006")
        self.assertEqual(inst.item[0].item[0].item[0].item[2].concept[0].display, "Myocardial infarction (disorder)")
        self.assertEqual(inst.item[0].item[0].item[0].item[2].concept[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(inst.item[0].linkId, "1")
        self.assertEqual(inst.item[0].type, "group")
        self.assertEqual(inst.item[1].concept[0].code, "HISTOPATHOLOGY")
        self.assertEqual(inst.item[1].concept[0].system, "http://example.org/system/code/sections")
        self.assertEqual(inst.item[1].item[0].concept[0].code, "ABDOMINAL")
        self.assertEqual(inst.item[1].item[0].concept[0].system, "http://example.org/system/code/sections")
        self.assertEqual(inst.item[1].item[0].item[0].concept[0].code, "STADPT")
        self.assertEqual(inst.item[1].item[0].item[0].concept[0].display, "pT category")
        self.assertEqual(inst.item[1].item[0].item[0].concept[0].system, "http://example.org/system/code/questions")
