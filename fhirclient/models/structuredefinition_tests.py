...
class StructureDefinitionTests(unittest.TestCase):
    ...
    def implStructureDefinition1(self, inst):
        ...
        self.assertEqual(inst.differential.element[2].fixedUri, "index")
        self.assertEqual(inst.differential.element[2].id, "Extension:anadditionalexamplevalue.extension:index.url")
        self.assertEqual(inst.differential.element[2].path, "Extension.extension.url")
        self.assertEqual(inst.differential.element[2].type[0].code, "uri")
        self.assertEqual(inst.differential.element[3].id, "Extension:anadditionalexamplevalue.extension:index.valueString")
        self.assertEqual(inst.differential.element[3].path, "Extension.extension.valueString")
        self.assertEqual(inst.differential.element[3].type[0].code, "string")
        self.assertEqual(inst.differential.element[4].definition, "Value of the example.")
        self.assertEqual(inst.differential.element[4].id, "Extension:anadditionalexamplevalue.extension:exvalue")
        self.assertEqual(inst.differential.element[4].max, "1")
        self.assertEqual(inst.differential.element[4].min, 0)
        self.assertEqual(inst.differential.element[4].path, "Extension.extension")
        self.assertEqual(inst.differential.element[4].short, "Value of the example")
        self.assertEqual(inst.differential.element[4].sliceName, "exValue")
        self.assertEqual(inst.differential.element[4].type[0].code, "Extension")
        self.assertEqual(inst.differential.element[5].id, "Extension:anadditionalexamplevalue.extension:exvalue.extension:extension")
        self.assertEqual(inst.differential.element[5].max, "0")
        self.assertEqual(inst.differential.element[5].path, "Extension.extension.extension")
        self.assertEqual(inst.differential.element[5].sliceName, "extension")
        self.assertEqual(inst.differential.element[6].fixedUri, "exValue")
        self.assertEqual(inst.differential.element[6].id, "Extension:anadditionalexamplevalue.extension:exvalue.url")
        self.assertEqual(inst.differential.element[6].path, "Extension.extension.url")
        self.assertEqual(inst.differential.element[6].type[0].code, "uri")
        self.assertEqual(inst.differential.element[7].id, "Extension:anadditionalexamplevalue.extension:exvalue.value[x]")
        self.assertEqual(inst.differential.element[7].min, 1)
        self.assertEqual(inst.differential.element[7].path, "Extension.extension.value[x]")
        self.assertEqual(inst.differential.element[7].type[0].code, "base64Binary")
        self.assertEqual(inst.differential.element[7].type[1].code, "boolean")
        self.assertEqual(inst.differential.element[7].type[2].code, "code")
        self.assertEqual(inst.differential.element[7].type[3].code, "date")
        self.assertEqual(inst.differential.element[7].type[4].code, "dateTime")
        self.assertEqual(inst.differential.element[7].type[5].code, "decimal")
        self.assertEqual(inst.differential.element[7].type[6].code, "id")
        self.assertEqual(inst.differential.element[7].type[7].code, "instant")
        self.assertEqual(inst.differential.element[7].type[8].code, "integer")
        self.assertEqual(inst.differential.element[7].type[9].code, "markdown")
        self.assertEqual(inst.differential.element[8].fixedUri, "http://hl7.org/fhir/StructureDefinition/structuredefinition-example")
        self.assertEqual(inst.differential.element[8].id, "Extension:anadditionalexamplevalue.url")
        self.assertEqual(inst.differential.element[8].path, "Extension.url")
        self.assertEqual(inst.differential.element[8].type[0].code, "uri")
        self.assertEqual(inst.differential.element[9].id, "Extension:anadditionalexamplevalue.valueString")
        self.assertEqual(inst.differential.element[9].path, "Extension.valueString")
        self.assertEqual(inst.differential.element[9].type[0].code, "string")
        ...
        self.assertEqual(inst.snapshot.element[2].slicing.id, "79")
        ...
        self.assertEqual(inst.snapshot.element[5].alias[0], "extensions")
        self.assertEqual(inst.snapshot.element[5].alias[1], "user content")
        ...
        self.assertEqual(inst.snapshot.element[5].id, "Extension:anadditionalexamplevalue.extension:index.extension")
        self.assertEqual(inst.snapshot.element[5].mapping[0].identity, "rim")
        self.assertEqual(inst.snapshot.element[5].mapping[0].map, "n/a")
        self.assertEqual(inst.snapshot.element[5].max, "*")
        ...
        self.assertEqual(inst.snapshot.element[5].short, "Additional Content defined by implementations")
        ...
        self.assertEqual(inst.snapshot.element[7].min, 0)
