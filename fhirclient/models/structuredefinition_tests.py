...
class StructureDefinitionTests(unittest.TestCase):
    ...
    def implStructureDefinition1(self, inst):
        ...
        self.assertEqual(inst.differential.element[0].id, "Extension")
        ...
        self.assertEqual(inst.differential.element[0].type[0].code, "Extension")
        self.assertEqual(inst.differential.element[1].definition, "Key for this example.")
        self.assertEqual(inst.differential.element[1].id, "Extension.extension")
        ...
        self.assertEqual(inst.differential.element[2].id, "Extension.extension.extension")
        ...
        self.assertEqual(inst.differential.element[3].id, "Extension.extension.url")
        ...
        self.assertEqual(inst.differential.element[4].id, "Extension.extension.value[x]")
        ...
        self.assertEqual(inst.differential.element[5].id, "Extension.extension")
        ...
        self.assertEqual(inst.differential.element[6].id, "Extension.extension.extension")
        ...
        self.assertEqual(inst.differential.element[7].id, "Extension.extension.url")
        ...
        self.assertEqual(inst.differential.element[8].id, "Extension.extension.value[x]")
        ...
        self.assertEqual(inst.differential.element[8].type[0].code, "boolean")
        self.assertEqual(inst.differential.element[8].type[1].code, "integer")
        self.assertEqual(inst.differential.element[8].type[2].code, "decimal")
        self.assertEqual(inst.differential.element[8].type[3].code, "base64Binary")
        self.assertEqual(inst.differential.element[8].type[4].code, "instant")
        self.assertEqual(inst.differential.element[8].type[5].code, "string")
        self.assertEqual(inst.differential.element[8].type[6].code, "uri")
        self.assertEqual(inst.differential.element[8].type[7].code, "date")
        self.assertEqual(inst.differential.element[8].type[8].code, "dateTime")
        self.assertEqual(inst.differential.element[8].type[9].code, "time")
        self.assertEqual(inst.differential.element[9].fixedUri, "http://hl7.org/fhir/StructureDefinition/structuredefinition-example")
        self.assertEqual(inst.differential.element[9].id, "Extension.url")
        ...
        self.assertEqual(inst.snapshot.element[0].id, "Extension")
        ...
        self.assertEqual(inst.snapshot.element[0].type[0].code, "Extension")
        ...
        self.assertEqual(inst.snapshot.element[1].id, "Extension.id")
        ...
        self.assertEqual(inst.snapshot.element[2].id, "Extension.extension")
        ...
        self.assertEqual(inst.snapshot.element[2].slicing.id, "68")
        ...
        self.assertEqual(inst.snapshot.element[3].id, "Extension.extension")
        ...
        self.assertEqual(inst.snapshot.element[4].id, "Extension.id")
        ...
        self.assertEqual(inst.snapshot.element[5].id, "Extension.extension")
        ...
        self.assertEqual(inst.snapshot.element[6].id, "Extension.url")
        ...
        self.assertEqual(inst.snapshot.element[7].id, "Extension.value[x]")
        ...
        self.assertEqual(inst.snapshot.element[8].id, "Extension.extension")
        ...
        self.assertEqual(inst.snapshot.element[9].id, "Extension.id")
