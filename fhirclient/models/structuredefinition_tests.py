...
class StructureDefinitionTests(unittest.TestCase):
    ...
    def implStructureDefinition1(self, inst):
        ...
        self.assertEqual(inst.snapshot.element[1].definition, "unique id for the element within a resource (for internal references).")
        ...
        self.assertEqual(inst.snapshot.element[1].type[0].code, "id")
        ...
        self.assertEqual(inst.snapshot.element[4].definition, "unique id for the element within a resource (for internal references).")
        ...
        self.assertEqual(inst.snapshot.element[4].type[0].code, "id")
        ...
        self.assertEqual(inst.snapshot.element[9].definition, "unique id for the element within a resource (for internal references).")
        ...
        self.assertEqual(inst.snapshot.element[9].type[0].code, "id")
