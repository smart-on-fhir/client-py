...
class NutritionOrderTests(unittest.TestCase):
    def instantiate_from(self, filename):
        ...
        with io.open(os.path.join(datadir, filename), 'r', encoding='utf-8') as handle:
            js = json.load(handle)
        instance = nutritionorder.NutritionOrder(js)
        self.assertIsNotNone(instance, "Must have instantiated a test instance")
        return instance
    
    def testNutritionOrder1(self):
        inst = self.instantiate_from("nutritionorder-example-cardiacdiet.json")
        self.assertIsNotNone(inst, "Must have instantiated a <fhirclass.FHIRClass object at 0x10e343450> instance")
    
        self.assertEqual(inst.dateTime.date, FHIRDate("2014-09-17").date)
        self.assertEqual(inst.dateTime.isostring, "2014-09-17")
        ...
        self.assertEqual(inst.oralDiet.nutrient[0].amount.units, "grams")
        self.assertEqual(inst.oralDiet.nutrient[0].amount.value, 2)
        self.assertEqual(inst.oralDiet.nutrient[0].mod.coding[0].code, "39972003")
        self.assertEqual(inst.oralDiet.nutrient[0].mod.coding[0].display, "Sodium")
        self.assertEqual(inst.oralDiet.nutrient[0].mod.coding[0].system, "http://snomed.info/sct")
        ...
        self.assertEqual(inst.oralDiet.nutrient[1].amount.units, "milliliter")
        self.assertEqual(inst.oralDiet.nutrient[1].amount.value, 1500)
        self.assertEqual(inst.oralDiet.nutrient[1].mod.coding[0].code, "33463005")
        self.assertEqual(inst.oralDiet.nutrient[1].mod.coding[0].display, "Fluid")
        self.assertEqual(inst.oralDiet.nutrient[1].mod.coding[0].system, "http://snomed.info/sct")
    ...
    def testNutritionOrder2(self):
        ...
        self.assertEqual(inst.oralDiet.nutrient[0].mod.coding[0].code, "2331003")
        self.assertEqual(inst.oralDiet.nutrient[0].mod.coding[0].display, "Carbohydrate")
        self.assertEqual(inst.oralDiet.nutrient[0].mod.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.oralDiet.scheduled.repeat.bounds.start.date, FHIRDate("2015-02-10").date)
        self.assertEqual(inst.oralDiet.scheduled.repeat.bounds.start.isostring, "2015-02-10")
        self.assertEqual(inst.oralDiet.scheduled.repeat.frequency, 3)
        self.assertEqual(inst.oralDiet.scheduled.repeat.period, 1)
        self.assertEqual(inst.oralDiet.scheduled.repeat.periodUnits, "d")
    ...
    def testNutritionOrder3(self):
        ...
        self.assertEqual(inst.supplement[0].quantity.units, "8 oz bottle")
        self.assertEqual(inst.supplement[0].quantity.value, 1)
        self.assertEqual(inst.supplement[0].scheduled.repeat.bounds.start.date, FHIRDate("2015-02-10").date)
        self.assertEqual(inst.supplement[0].scheduled.repeat.bounds.start.isostring, "2015-02-10")
        self.assertEqual(inst.supplement[0].scheduled.repeat.period, 1)
        self.assertEqual(inst.supplement[0].scheduled.repeat.periodUnits, "h")
        self.assertEqual(inst.supplement[0].scheduled.repeat.when, "HS")
    ...
    def testNutritionOrder4(self):
        ...
        self.assertEqual(inst.supplement[0].quantity.units, "8 oz can")
        self.assertEqual(inst.supplement[0].quantity.value, 1)
        self.assertEqual(inst.supplement[0].scheduled.repeat.bounds.start.date, FHIRDate("2015-02-10").date)
        self.assertEqual(inst.supplement[0].scheduled.repeat.bounds.start.isostring, "2015-02-10")
        self.assertEqual(inst.supplement[0].scheduled.repeat.frequency, 3)
        self.assertEqual(inst.supplement[0].scheduled.repeat.period, 1)
        self.assertEqual(inst.supplement[0].scheduled.repeat.periodUnits, "d")
    ...
    def testNutritionOrder5(self):
        ...
        self.assertEqual(inst.enteralFormula.administrationInstructions, "240 mls every 4hrs ")
        ...
        self.assertEqual(inst.enteralFormula.caloricDensity.units, "calories per milliliter")
        ...
        self.assertEqual(inst.enteralFormula.maxVolumeToDeliver.units, "milliliter/day")
        self.assertEqual(inst.enteralFormula.maxVolumeToDeliver.value, 1440)
        self.assertEqual(inst.enteralFormula.quantity.code, "mL")
        self.assertEqual(inst.enteralFormula.quantity.system, "http://unitsofmeasure.org")
        self.assertEqual(inst.enteralFormula.quantity.units, "milliliters")
        self.assertEqual(inst.enteralFormula.quantity.value, 240)
        ...
        self.assertEqual(inst.enteralFormula.scheduled.repeat.bounds.start.date, FHIRDate("2014-09-17").date)
        self.assertEqual(inst.enteralFormula.scheduled.repeat.bounds.start.isostring, "2014-09-17")
        self.assertEqual(inst.enteralFormula.scheduled.repeat.frequency, 1)
        self.assertEqual(inst.enteralFormula.scheduled.repeat.period, 4)
        self.assertEqual(inst.enteralFormula.scheduled.repeat.periodUnits, "h")
        self.assertEqual(inst.excludeFoodModifier[0].coding[0].code, "227493005")
        self.assertEqual(inst.excludeFoodModifier[0].coding[0].display, "Cashew Nut")
        self.assertEqual(inst.excludeFoodModifier[0].coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.excludeFoodModifier[0].coding[0].version, "20140730")
    ...
    def testNutritionOrder6(self):
        ...
        self.assertEqual(inst.dateTime.date, FHIRDate("2014-09-17").date)
        self.assertEqual(inst.dateTime.isostring, "2014-09-17")
        self.assertEqual(inst.enteralFormula.administrationInstructions, "Hold feedings from 7 pm to 7 am. Add MCT oil to increase calories from 1.0 cal/mL to 1.5 cal/mL")
        ...
        self.assertEqual(inst.enteralFormula.rate.denominator.code, "h")
        self.assertEqual(inst.enteralFormula.rate.denominator.system, "http://unitsofmeasure.org")
        self.assertEqual(inst.enteralFormula.rate.denominator.units, "hr")
        self.assertEqual(inst.enteralFormula.rate.denominator.value, 1)
        self.assertEqual(inst.enteralFormula.rate.numerator.code, "mL")
        self.assertEqual(inst.enteralFormula.rate.numerator.system, "http://unitsofmeasure.org")
        self.assertEqual(inst.enteralFormula.rate.numerator.units, "millilters")
        self.assertEqual(inst.enteralFormula.rate.numerator.value, 60)
        self.assertEqual(inst.enteralFormula.rateAdjustment.units, "milliliters every 4 hours")
        self.assertEqual(inst.enteralFormula.rateAdjustment.value, 10)
        self.assertEqual(inst.enteralFormula.routeofAdministration.coding[0].code, "NGT")
        self.assertEqual(inst.enteralFormula.routeofAdministration.coding[0].display, "Instillation, nasogastrostomy tube")
        self.assertEqual(inst.enteralFormula.routeofAdministration.coding[0].system, "http://hl7.org/fhir/v3/RouteOfAdministration")
        self.assertEqual(inst.enteralFormula.scheduled.event[0].date, FHIRDate("2014-09-17").date)
        self.assertEqual(inst.enteralFormula.scheduled.event[0].isostring, "2014-09-17")
    ...
    def testNutritionOrder7(self):
        ...
        self.assertEqual(inst.oralDiet.nutrient[0].mod.coding[0].code, "256674009")
        self.assertEqual(inst.oralDiet.nutrient[0].mod.coding[0].display, "Fat")
        self.assertEqual(inst.oralDiet.nutrient[0].mod.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.oralDiet.scheduled.repeat.bounds.start.date, FHIRDate("2015-02-10").date)
        self.assertEqual(inst.oralDiet.scheduled.repeat.bounds.start.isostring, "2015-02-10")
        self.assertEqual(inst.oralDiet.scheduled.repeat.frequency, 3)
    ...
    def testNutritionOrder8(self):
        ...
        self.assertEqual(inst.enteralFormula.additiveType.coding[0].system, "http://hl7.org/fhir/entformula-additive")
        self.assertEqual(inst.enteralFormula.administrationInstructions, "Add high calorie high carbohydrate additive to increase cal/oz from 24 cal/oz to 27 cal/oz.")
        ...
        self.assertEqual(inst.enteralFormula.caloricDensity.system, "http://unitsofmeasure.org")
        self.assertEqual(inst.enteralFormula.caloricDensity.units, "calories per ounce")
        ...
        self.assertEqual(inst.enteralFormula.maxVolumeToDeliver.system, "http://unitsofmeasure.org")
        self.assertEqual(inst.enteralFormula.maxVolumeToDeliver.units, "ounces")
        self.assertEqual(inst.enteralFormula.maxVolumeToDeliver.value, 32)
        self.assertEqual(inst.enteralFormula.quantity.code, "[foz_us]")
        self.assertEqual(inst.enteralFormula.quantity.system, "http://unitsofmeasure.org")
        self.assertEqual(inst.enteralFormula.quantity.units, "ounces")
        self.assertEqual(inst.enteralFormula.quantity.value, 4)
        ...
        self.assertTrue(inst.enteralFormula.routeofAdministration.coding[0].primary)
        self.assertEqual(inst.enteralFormula.routeofAdministration.coding[0].system, "http://hl7.org/fhir/v3/RouteOfAdministration")
        self.assertEqual(inst.enteralFormula.scheduled.repeat.bounds.start.date, FHIRDate("2014-09-17").date)
        self.assertEqual(inst.enteralFormula.scheduled.repeat.bounds.start.isostring, "2014-09-17")
        self.assertEqual(inst.enteralFormula.scheduled.repeat.frequency, 1)
        self.assertEqual(inst.enteralFormula.scheduled.repeat.period, 3)
        self.assertEqual(inst.enteralFormula.scheduled.repeat.periodUnits, "h")
    ...
    def testNutritionOrder9(self):
        ...
        self.assertEqual(inst.supplement[0].quantity.units, "scoop")
        self.assertEqual(inst.supplement[0].quantity.value, 1)
        self.assertEqual(inst.supplement[0].scheduled.repeat.bounds.start.date, FHIRDate("2015-02-10").date)
        self.assertEqual(inst.supplement[0].scheduled.repeat.bounds.start.isostring, "2015-02-10")
        self.assertEqual(inst.supplement[0].scheduled.repeat.when, "C")
    ...
    def testNutritionOrder10(self):
        ...
        self.assertEqual(inst.oralDiet.scheduled.repeat.period, 1)
        self.assertEqual(inst.oralDiet.scheduled.repeat.periodUnits, "d")
        self.assertEqual(inst.oralDiet.texture[0].mod.coding[0].code, "228055009")
        self.assertEqual(inst.oralDiet.texture[0].mod.coding[0].display, "Liquidized food")
        self.assertEqual(inst.oralDiet.texture[0].mod.coding[0].system, "http://snomed.info/sct")
        self.assertEqual(inst.oralDiet.texture[0].mod.text, "Pureed")
