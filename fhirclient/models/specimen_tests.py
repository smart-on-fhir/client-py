...
class SpecimenTests(unittest.TestCase):
    def instantiate_from(self, filename):
        ...
        with io.open(os.path.join(datadir, filename), 'r', encoding='utf-8') as handle:
            js = json.load(handle)
        instance = specimen.Specimen(js)
        self.assertIsNotNone(instance, "Must have instantiated a test instance")
        return instance
    
    def testSpecimen1(self):
        inst = self.instantiate_from("spec-uslab-example1.json")
        self.assertIsNotNone(inst, "Must have instantiated a <fhirclass.FHIRClass object at 0x10e399110> instance")
        ...
        self.assertEqual(inst.collection.collectedDateTime.isostring, "2014-12-05")
    ...
    def testSpecimen3(self):
        ...
        self.assertEqual(inst.collection.collectedDateTime.isostring, "2011-05-30T06:15:00Z")
        ...
        self.assertEqual(inst.receivedTime.isostring, "2011-03-04T07:03:00Z")
        self.assertEqual(inst.text.status, "generated")
        self.assertEqual(inst.type.coding[0].code, "122555007")
        self.assertEqual(inst.type.coding[0].display, "Venous blood specimen")
        self.assertEqual(inst.type.coding[0].system, "http://snomed.info/sct")
    ...
    def testSpecimen4(self):
        ...
        self.assertEqual(inst.collection.collectedDateTime.isostring, "2011-03-06T06:15:00Z")
        ...
        self.assertEqual(inst.treatment[0].extension[0].valuePeriod.end.isostring, "2011-03-04T07:03:00Z")
        self.assertEqual(inst.treatment[0].extension[0].valuePeriod.start.date, FHIRDate("2011-03-04T07:03:00Z").date)
        self.assertEqual(inst.treatment[0].extension[0].valuePeriod.start.isostring, "2011-03-04T07:03:00Z")
        self.assertEqual(inst.type.coding[0].code, "122555007")
        self.assertEqual(inst.type.coding[0].display, "Venous blood specimen")
        self.assertEqual(inst.type.coding[0].system, "http://snomed.info/sct")
