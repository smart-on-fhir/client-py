...
class AuditEventTests(unittest.TestCase):
    ...
    def implAuditEvent1(self, inst):
        ...
        self.assertEqual(inst.agent[1].role[0].coding[0].system, "http://nema.org/dicom/dicm")
        ...
        self.assertEqual(inst.type.system, "http://nema.org/dicom/dicm")
    ...
    def implAuditEvent3(self, inst):
        ...
        self.assertEqual(inst.agent[0].role[0].coding[0].system, "http://nema.org/dicom/dicm")
        ...
        self.assertEqual(inst.agent[2].media.system, "http://nema.org/dicom/dicm")
    ...
    def implAuditEvent6(self, inst):
        ...
        self.assertEqual(inst.entity[0].lifecycle.system, "http://hl7.org/fhir/object-lifecycle")
        self.assertEqual(inst.entity[0].type.code, "2")
        self.assertEqual(inst.entity[0].type.display, "System Object")
        self.assertEqual(inst.entity[0].type.system, "http://hl7.org/fhir/object-type")
    ...
    def implAuditEvent7(self, inst):
        ...
        self.assertEqual(inst.entity[0].role.code, "1")
        self.assertEqual(inst.entity[0].role.display, "Patient")
        self.assertEqual(inst.entity[0].role.system, "http://hl7.org/fhir/valueset-object-role")
        self.assertEqual(inst.entity[0].type.code, "1")
        self.assertEqual(inst.entity[0].type.display, "Person")
        self.assertEqual(inst.entity[0].type.system, "http://hl7.org/fhir/object-type")
        ...
        self.assertEqual(inst.entity[1].lifecycle.system, "http://hl7.org/fhir/object-lifecycle")
        self.assertEqual(inst.entity[1].name, "Namne of What")
        self.assertEqual(inst.entity[1].role.code, "4")
        self.assertEqual(inst.entity[1].role.display, "DomainResource")
        self.assertEqual(inst.entity[1].role.system, "http://hl7.org/fhir/valueset-object-role")
