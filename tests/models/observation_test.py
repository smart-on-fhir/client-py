...
class ObservationTests(unittest.TestCase):
    ...
    def implObservation4(self, inst):
        ...
        self.assertEqual(inst.effectiveDateTime.datetime, FHIRDateTime("2016-03-28").datetime)
    ...
    def implObservation10(self, inst):
        ...
        self.assertEqual(inst.effectiveDateTime.datetime, FHIRDateTime("2016-05-18").datetime)
