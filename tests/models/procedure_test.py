...
class ProcedureTests(unittest.TestCase):
    ...
    def implProcedure1(self, inst):
        ...
        self.assertEqual(inst.performedPeriod.end.datetime, FHIRDateTime("2013-01-28T14:27:00+01:00").datetime)
        self.assertEqual(inst.performedPeriod.end.as_json(), "2013-01-28T14:27:00+01:00")
        self.assertEqual(inst.performedPeriod.start.datetime, FHIRDateTime("2013-01-28T13:31:00+01:00").datetime)
    ...
    def implProcedure8(self, inst):
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.performedDateTime.datetime, FHIRDateTime("2016-09-27").datetime)
    ...
    def implProcedure10(self, inst):
        ...
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.note[0].text, "Routine Appendectomy. Appendix was inflamed and in retro-caecal position")
        self.assertEqual(inst.performedDateTime.datetime, FHIRDateTime("2013-04-05").datetime)
