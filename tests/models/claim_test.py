...
class ClaimTests(unittest.TestCase):
    ...
    def implClaim1(self, inst):
        ...
        self.assertEqual(inst.billablePeriod.end.datetime, FHIRDateTime("2014-08-16").datetime)
        self.assertEqual(inst.billablePeriod.end.as_json(), "2014-08-16")
        self.assertEqual(inst.billablePeriod.start.datetime, FHIRDateTime("2014-08-15").datetime)
        ...
        self.assertEqual(inst.supportingInfo[0].timingPeriod.end.datetime, FHIRDateTime("2014-08-16").datetime)
        self.assertEqual(inst.supportingInfo[0].timingPeriod.end.as_json(), "2014-08-16")
        self.assertEqual(inst.supportingInfo[0].timingPeriod.start.datetime, FHIRDateTime("2014-08-16").datetime)
        ...
        self.assertEqual(inst.supportingInfo[1].timingPeriod.end.datetime, FHIRDateTime("2014-08-16").datetime)
        self.assertEqual(inst.supportingInfo[1].timingPeriod.end.as_json(), "2014-08-16")
        self.assertEqual(inst.supportingInfo[1].timingPeriod.start.datetime, FHIRDateTime("2014-08-15").datetime)
    ...
    def implClaim10(self, inst):
        ...
        self.assertEqual(inst.created.datetime, FHIRDateTime("2015-10-16T00:00:00-07:00").datetime)
        ...
        self.assertEqual(inst.supportingInfo[0].category.coding[0].system, "http://terminology.hl7.org/CodeSystem/claiminformationcategory")
        self.assertEqual(inst.supportingInfo[0].sequence, 1)
        self.assertEqual(inst.supportingInfo[0].timingPeriod.end.datetime, FHIRDateTime("2015-10-05T00:00:00-07:00").datetime)
        self.assertEqual(inst.supportingInfo[0].timingPeriod.end.as_json(), "2015-10-05T00:00:00-07:00")
        self.assertEqual(inst.supportingInfo[0].timingPeriod.start.datetime, FHIRDateTime("2015-10-01T00:00:00-07:00").datetime)
