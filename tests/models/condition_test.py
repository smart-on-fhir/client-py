...
class ConditionTests(unittest.TestCase):
    ...
    def implCondition9(self, inst):
        ...
        self.assertEqual(inst.recordedDate.datetime, FHIRDateTime("2012-12-01").datetime)
    ...
    def implCondition10(self, inst):
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.onsetDateTime.datetime, FHIRDateTime("2013-04-02").datetime)
