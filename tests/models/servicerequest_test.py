...
class ServiceRequestTests(unittest.TestCase):
    ...
    def implServiceRequest3(self, inst):
        ...
        self.assertEqual(inst.occurrenceDateTime.datetime, FHIRDateTime("2013-05-02T16:16:00-07:00").datetime)
    ...
    def implServiceRequest7(self, inst):
        self.assertEqual(inst.authoredOn.datetime, FHIRDateTime("2018-02-20").datetime)
    ...
    def implServiceRequest9(self, inst):
        self.assertEqual(inst.authoredOn.datetime, FHIRDateTime("2016-09-20").datetime)
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.occurrenceDateTime.datetime, FHIRDateTime("2016-09-27").datetime)
