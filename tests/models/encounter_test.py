...
class EncounterTests(unittest.TestCase):
    ...
    def implEncounter4(self, inst):
        ...
        self.assertEqual(inst.classHistory[0].period.end.datetime, FHIRDateTime("2017-02-01T09:27:00+10:00").datetime)
        self.assertEqual(inst.classHistory[0].period.end.as_json(), "2017-02-01T09:27:00+10:00")
        self.assertEqual(inst.classHistory[0].period.start.datetime, FHIRDateTime("2017-02-01T07:15:00+10:00").datetime)
        ...
        self.assertEqual(inst.classHistory[1].period.start.datetime, FHIRDateTime("2017-02-01T09:27:00+10:00").datetime)
        ...
        self.assertEqual(inst.location[0].period.end.datetime, FHIRDateTime("2017-02-01T08:45:00+10:00").datetime)
        self.assertEqual(inst.location[0].period.end.as_json(), "2017-02-01T08:45:00+10:00")
        self.assertEqual(inst.location[0].period.start.datetime, FHIRDateTime("2017-02-01T07:15:00+10:00").datetime)
        ...
        self.assertEqual(inst.location[1].period.end.datetime, FHIRDateTime("2017-02-01T09:27:00+10:00").datetime)
        self.assertEqual(inst.location[1].period.end.as_json(), "2017-02-01T09:27:00+10:00")
        self.assertEqual(inst.location[1].period.start.datetime, FHIRDateTime("2017-02-01T08:45:00+10:00").datetime)
        ...
        self.assertEqual(inst.location[2].period.end.datetime, FHIRDateTime("2017-02-01T12:15:00+10:00").datetime)
        self.assertEqual(inst.location[2].period.end.as_json(), "2017-02-01T12:15:00+10:00")
        self.assertEqual(inst.location[2].period.start.datetime, FHIRDateTime("2017-02-01T09:27:00+10:00").datetime)
        ...
        self.assertEqual(inst.location[3].period.end.datetime, FHIRDateTime("2017-02-01T12:45:00+10:00").datetime)
        self.assertEqual(inst.location[3].period.end.as_json(), "2017-02-01T12:45:00+10:00")
        self.assertEqual(inst.location[3].period.start.datetime, FHIRDateTime("2017-02-01T12:15:00+10:00").datetime)
        ...
        self.assertEqual(inst.location[4].period.start.datetime, FHIRDateTime("2017-02-01T12:45:00+10:00").datetime)
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.period.start.datetime, FHIRDateTime("2017-02-01T07:15:00+10:00").datetime)
        self.assertEqual(inst.period.start.as_json(), "2017-02-01T07:15:00+10:00")
        self.assertEqual(inst.status, "in-progress")
        self.assertEqual(inst.statusHistory[0].period.end.datetime, FHIRDateTime("2017-02-01T07:35:00+10:00").datetime)
        self.assertEqual(inst.statusHistory[0].period.end.as_json(), "2017-02-01T07:35:00+10:00")
        self.assertEqual(inst.statusHistory[0].period.start.datetime, FHIRDateTime("2017-02-01T07:15:00+10:00").datetime)
        ...
        self.assertEqual(inst.statusHistory[1].period.end.datetime, FHIRDateTime("2017-02-01T08:45:00+10:00").datetime)
        self.assertEqual(inst.statusHistory[1].period.end.as_json(), "2017-02-01T08:45:00+10:00")
        self.assertEqual(inst.statusHistory[1].period.start.datetime, FHIRDateTime("2017-02-01T07:35:00+10:00").datetime)
        ...
        self.assertEqual(inst.statusHistory[2].period.end.datetime, FHIRDateTime("2017-02-01T12:15:00+10:00").datetime)
        self.assertEqual(inst.statusHistory[2].period.end.as_json(), "2017-02-01T12:15:00+10:00")
        self.assertEqual(inst.statusHistory[2].period.start.datetime, FHIRDateTime("2017-02-01T08:45:00+10:00").datetime)
        ...
        self.assertEqual(inst.statusHistory[3].period.end.datetime, FHIRDateTime("2017-02-01T12:45:00+10:00").datetime)
        self.assertEqual(inst.statusHistory[3].period.end.as_json(), "2017-02-01T12:45:00+10:00")
        self.assertEqual(inst.statusHistory[3].period.start.datetime, FHIRDateTime("2017-02-01T12:15:00+10:00").datetime)
        ...
        self.assertEqual(inst.statusHistory[4].period.start.datetime, FHIRDateTime("2017-02-01T12:45:00+10:00").datetime)
    ...
    def implEncounter5(self, inst):
        ...
        self.assertEqual(inst.location[0].period.end.datetime, FHIRDateTime("2015-01-17T16:30:00+10:00").datetime)
        self.assertEqual(inst.location[0].period.end.as_json(), "2015-01-17T16:30:00+10:00")
        self.assertEqual(inst.location[0].period.start.datetime, FHIRDateTime("2015-01-17T16:00:00+10:00").datetime)
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.participant[0].period.end.datetime, FHIRDateTime("2015-01-17T16:30:00+10:00").datetime)
        self.assertEqual(inst.participant[0].period.end.as_json(), "2015-01-17T16:30:00+10:00")
        self.assertEqual(inst.participant[0].period.start.datetime, FHIRDateTime("2015-01-17T16:00:00+10:00").datetime)
        self.assertEqual(inst.participant[0].period.start.as_json(), "2015-01-17T16:00:00+10:00")
        self.assertEqual(inst.period.end.datetime, FHIRDateTime("2015-01-17T16:30:00+10:00").datetime)
        self.assertEqual(inst.period.end.as_json(), "2015-01-17T16:30:00+10:00")
        self.assertEqual(inst.period.start.datetime, FHIRDateTime("2015-01-17T16:00:00+10:00").datetime)
    ...
    def implEncounter7(self, inst):
        ...
        self.assertEqual(inst.period.end.datetime, FHIRDateTime("2013-03-20").datetime)
        ...
        self.assertEqual(inst.status, "finished")
        self.assertEqual(inst.statusHistory[0].period.start.datetime, FHIRDateTime("2013-03-08").datetime)
