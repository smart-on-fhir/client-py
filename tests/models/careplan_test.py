...
class CarePlanTests(unittest.TestCase):
    ...
    def implCarePlan1(self, inst):
        ...
        self.assertEqual(inst.period.end.datetime, FHIRDateTime("2013-04-21").datetime)
        self.assertEqual(inst.period.end.as_json(), "2013-04-21")
        self.assertEqual(inst.period.start.datetime, FHIRDateTime("2013-04-14").datetime)
    ...
    def implCarePlan3(self, inst):
        ...
        self.assertEqual(inst.activity[0].detail.scheduledPeriod.end.datetime, FHIRDateTime("2013-01-01T10:50:00+00:00").datetime)
        self.assertEqual(inst.activity[0].detail.scheduledPeriod.end.as_json(), "2013-01-01T10:50:00+00:00")
        self.assertEqual(inst.activity[0].detail.scheduledPeriod.start.datetime, FHIRDateTime("2013-01-01T10:38:00+00:00").datetime)
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.period.start.datetime, FHIRDateTime("2013-01-01T10:30:00+00:00").datetime)
    ...
    def implCarePlan4(self, inst):
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.period.end.datetime, FHIRDateTime("2013-07-07").datetime)
        self.assertEqual(inst.period.end.as_json(), "2013-07-07")
        self.assertEqual(inst.period.start.datetime, FHIRDateTime("2011-07-06").datetime)
    ...
    def implCarePlan5(self, inst):
        ...
        self.assertEqual(inst.activity[0].detail.scheduledPeriod.start.datetime, FHIRDateTime("2012-09-10").datetime)
        ...
        self.assertEqual(inst.activity[0].progress[0].time.datetime, FHIRDateTime("2012-09-10").datetime)
        ...
        self.assertEqual(inst.activity[1].detail.scheduledPeriod.start.datetime, FHIRDateTime("2012-09-10").datetime)
        ...
        self.assertEqual(inst.activity[1].progress[0].time.datetime, FHIRDateTime("2012-09-10").datetime)
        ...
        self.assertEqual(inst.activity[2].detail.scheduledPeriod.start.datetime, FHIRDateTime("2012-09-10").datetime)
        ...
        self.assertEqual(inst.activity[3].detail.scheduledPeriod.start.datetime, FHIRDateTime("2012-08-27").datetime)
        ...
        self.assertEqual(inst.activity[3].progress[0].time.datetime, FHIRDateTime("2012-08-27").datetime)
        ...
        self.assertEqual(inst.activity[3].progress[1].time.datetime, FHIRDateTime("2012-09-10").datetime)
        ...
        self.assertEqual(inst.activity[4].detail.scheduledPeriod.start.datetime, FHIRDateTime("2012-07-23").datetime)
        ...
        self.assertEqual(inst.activity[4].progress[0].time.datetime, FHIRDateTime("2012-08-13").datetime)
        ...
        self.assertEqual(inst.activity[4].progress[1].time.datetime, FHIRDateTime("2012-09-10").datetime)
        ...
        self.assertEqual(inst.activity[5].detail.scheduledPeriod.start.datetime, FHIRDateTime("2012-07-23").datetime)
        ...
        self.assertEqual(inst.activity[6].detail.scheduledPeriod.start.datetime, FHIRDateTime("2012-07-23").datetime)
        ...
        self.assertEqual(inst.activity[6].progress[0].time.datetime, FHIRDateTime("2012-08-13").datetime)
        ...
        self.assertEqual(inst.activity[6].progress[1].time.datetime, FHIRDateTime("2012-08-27").datetime)
        ...
        self.assertEqual(inst.activity[7].detail.scheduledPeriod.start.datetime, FHIRDateTime("2012-07-10").datetime)
        ...
        self.assertEqual(inst.activity[7].progress[0].time.datetime, FHIRDateTime("2012-07-23").datetime)
        ...
        self.assertEqual(inst.activity[8].detail.scheduledPeriod.start.datetime, FHIRDateTime("2012-07-23").datetime)
        ...
        self.assertEqual(inst.activity[8].progress[0].time.datetime, FHIRDateTime("2012-07-30").datetime)
        ...
        self.assertEqual(inst.activity[8].progress[1].time.datetime, FHIRDateTime("2012-08-13").datetime)
        ...
        self.assertEqual(inst.activity[9].detail.scheduledPeriod.start.datetime, FHIRDateTime("2012-07-10").datetime)
    ...
    def implCarePlan6(self, inst):
        ...
        self.assertFalse(inst.activity[1].detail.doNotPerform)
        self.assertEqual(inst.activity[1].detail.kind, "Appointment")
        self.assertEqual(inst.activity[1].detail.scheduledTiming.repeat.boundsPeriod.end.datetime, FHIRDateTime("2013-02-28").datetime)
        self.assertEqual(inst.activity[1].detail.scheduledTiming.repeat.boundsPeriod.end.as_json(), "2013-02-28")
        self.assertEqual(inst.activity[1].detail.scheduledTiming.repeat.boundsPeriod.start.datetime, FHIRDateTime("2013-02-14").datetime)
        ...
        self.assertEqual(inst.activity[2].detail.scheduledTiming.repeat.boundsPeriod.end.datetime, FHIRDateTime("2013-03-14").datetime)
        self.assertEqual(inst.activity[2].detail.scheduledTiming.repeat.boundsPeriod.end.as_json(), "2013-03-14")
        self.assertEqual(inst.activity[2].detail.scheduledTiming.repeat.boundsPeriod.start.datetime, FHIRDateTime("2013-03-01").datetime)
        ...
        self.assertEqual(inst.activity[3].detail.scheduledTiming.repeat.boundsPeriod.end.datetime, FHIRDateTime("2013-09-14").datetime)
        self.assertEqual(inst.activity[3].detail.scheduledTiming.repeat.boundsPeriod.end.as_json(), "2013-09-14")
        self.assertEqual(inst.activity[3].detail.scheduledTiming.repeat.boundsPeriod.start.datetime, FHIRDateTime("2013-09-01").datetime)
        ...
        self.assertEqual(inst.extension[0].valueDateTime.datetime, FHIRDateTime("2013-01-01").datetime)
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.period.end.datetime, FHIRDateTime("2013-10-01").datetime)
        self.assertEqual(inst.period.end.as_json(), "2013-10-01")
        self.assertEqual(inst.period.start.datetime, FHIRDateTime("2013-01-01").datetime)
    ...
    def implCarePlan7(self, inst):
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.period.end.datetime, FHIRDateTime("2013-03-13").datetime)
        self.assertEqual(inst.period.end.as_json(), "2013-03-13")
        self.assertEqual(inst.period.start.datetime, FHIRDateTime("2013-03-11").datetime)
    ...
    def implCarePlan8(self, inst):
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.period.end.datetime, FHIRDateTime("2013-03-08T09:30:10+01:00").datetime)
        self.assertEqual(inst.period.end.as_json(), "2013-03-08T09:30:10+01:00")
        self.assertEqual(inst.period.start.datetime, FHIRDateTime("2013-03-08T09:00:10+01:00").datetime)
    ...
    def implCarePlan9(self, inst):
        ...
        self.assertEqual(inst.contained[0].id, "p1")
        self.assertEqual(inst.created.datetime, FHIRDateTime("2016-01-01").datetime)
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.period.end.datetime, FHIRDateTime("2017-06-01").datetime)
    ...
    def implCarePlan10(self, inst):
        ...
        self.assertEqual(inst.meta.tag[0].display, "test health data")
        self.assertEqual(inst.meta.tag[0].system, "http://terminology.hl7.org/CodeSystem/v3-ActReason")
        self.assertEqual(inst.period.end.datetime, FHIRDateTime("2011-06-27").datetime)
        self.assertEqual(inst.period.end.as_json(), "2011-06-27")
        self.assertEqual(inst.period.start.datetime, FHIRDateTime("2011-06-26").datetime)
